...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ShiroRikkaのBlog', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '⁺✞ʚ小鳥遊六花重度依赖ɞ✟₊', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.shirorikka.dpdns.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ShiroRikkaの小窝, ShiroRikka, blog.shirorikka.dpdns.org', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://gh-proxy.org/https://raw.githubusercontent.com/ShiroRikka/picx-images-hosting/master/source/images/favicon.3nrrz16ehf.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20251190号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20251190', // 备案查询链接，如果用了萌备等备案请在这里填写
